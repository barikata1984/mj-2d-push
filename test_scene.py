...
Requires:
  - /workspace/assets symlink -> mujoco_menagerie/universal_robots_ur5e/assets/
"""
...
def main():
  ...
  tip_id = mujoco.mj_name2id(m, mujoco.mjtObj.mjOBJ_SITE, 'pusher_tip_site')
  ...
  print(
    f'  Pusher-slider gap (y): {gap_y * 1000:.2f} mm (positive = no contact)'
  )
  print(
    f'  Pusher tip z in slider range [{slider_pos[2] - 0.015:.4f}, {slider_pos[2] + 0.015:.4f}]: '
